...
(function() {
  var Galaxy, Game, GameUtil, Order, Planet, PlanetPopulation, PlanetSize, Point, Range, Ship, TurnMessage, TurnResult, UID, color, debugMessage, enemyId, getNearestPlanet, getOrders, getOtherPlayerId, getOtherPlayerPlanets, id, name;
